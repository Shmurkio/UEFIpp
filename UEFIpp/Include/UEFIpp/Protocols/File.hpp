...
[[nodiscard]] constexpr auto ToMask(FileAttribute Attribute)
    -> Foundation::Uint64 {
  return Foundation::Cast::Auto<Foundation::Uint64>(Attribute);
}

[[nodiscard]] constexpr auto operator|(FileOpenMode Left, FileOpenMode Right)
    -> Foundation::Uint64 {
  return ToMask(Left) | ToMask(Right);
}

[[nodiscard]] constexpr auto operator|(Foundation::Uint64 Left,
                                       FileOpenMode Right)
    -> Foundation::Uint64 {
  return Left | ToMask(Right);
}

[[nodiscard]] constexpr auto operator|(FileAttribute Left, FileAttribute Right)
    -> Foundation::Uint64 {
  return ToMask(Left) | ToMask(Right);
}
...
using FileOpenFn = UEFI::StatusCode (*)(File *This, File **NewHandle,
                                        const Foundation::WChar *FileName,
                                        Foundation::Uint64 OpenMode,
                                        Foundation::Uint64 Attributes);
using FileCloseFn = UEFI::StatusCode (*)(File *This);
using FileDeleteFn = UEFI::StatusCode (*)(File *This);
using FileReadFn = UEFI::StatusCode (*)(File *This,
                                        Foundation::UintN *BufferSize,
                                        Foundation::Void *Buffer);
using FileWriteFn = UEFI::StatusCode (*)(File *This,
                                         Foundation::UintN *BufferSize,
                                         const Foundation::Void *Buffer);
using FileGetPositionFn = UEFI::StatusCode (*)(File *This,
                                               Foundation::Uint64 *Position);
using FileSetPositionFn = UEFI::StatusCode (*)(File *This,
                                               Foundation::Uint64 Position);
using FileGetInfoFn = UEFI::StatusCode (*)(File *This,
                                           const UEFI::Guid *InformationType,
                                           Foundation::UintN *BufferSize,
                                           Foundation::Void *Buffer);
using FileSetInfoFn = UEFI::StatusCode (*)(File *This,
                                           const UEFI::Guid *InformationType,
                                           Foundation::UintN BufferSize,
                                           const Foundation::Void *Buffer);
...
public:
  ...
  [[nodiscard]] auto
  OpenFile(File *&NewHandle, const Foundation::WChar *FileName,
           Foundation::Uint64 OpenMode, Foundation::Uint64 Attributes = 0)
      -> UEFI::StatusCode;
  ...
  [[nodiscard]] auto ReadFile(Foundation::Void *Buffer,
                              Foundation::UintN &BufferSize)
      -> UEFI::StatusCode;

  [[nodiscard]] auto WriteFile(const Foundation::Void *Buffer,
                               Foundation::UintN &BufferSize)
      -> UEFI::StatusCode;

  [[nodiscard]] auto CurrentPosition(Foundation::Uint64 &Position)
      -> UEFI::StatusCode;

  [[nodiscard]] auto SetCurrentPosition(Foundation::Uint64 Position)
      -> UEFI::StatusCode;

  [[nodiscard]] auto QueryInfo(UEFI::Guid &InformationType,
                               Foundation::Void *Buffer,
                               Foundation::UintN &BufferSize)
      -> UEFI::StatusCode;

  [[nodiscard]] auto UpdateInfo(UEFI::Guid &InformationType,
                                Foundation::Void *Buffer,
                                Foundation::UintN BufferSize)
      -> UEFI::StatusCode;
