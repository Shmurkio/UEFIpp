...
template <typename TProtocol> class ProtocolTraits;

template <typename TProtocol>
concept Protocol = requires {
  {
    ProtocolTraits<TProtocol>::Id
  } -> Foundation::Concepts::Same<const UEFI::Guid &>;
};

template <> class ProtocolTraits<SimpleTextInput> {
public:
...
template <> class ProtocolTraits<SimpleTextInputEx> {
public:
  inline static constexpr UEFI::Guid Id{
      0xdd9e7534,
      0x7762,
...
template <> class ProtocolTraits<SimpleTextOutput> {
public:
  inline static constexpr UEFI::Guid Id{
      0x387477c2,
      0x69c7,
...
template <> class ProtocolTraits<File> {
public:
  inline static constexpr UEFI::Guid Id{
      0x9576e91,
      0x6d3f,
...
template <> class ProtocolTraits<LoadedImage> {
public:
  inline static constexpr UEFI::Guid Id{
      0x5b1b31a1,
      0x9562,
...
template <> class ProtocolTraits<PciIo> {
public:
  inline static constexpr UEFI::Guid Id{
      0x4cf5b200,
      0x68b8,
...
template <> class ProtocolTraits<Tcp4ServiceBinding> {
public:
  inline static constexpr UEFI::Guid Id{
      0x00720665,
      0x67eb,
...
template <> class ProtocolTraits<Tcp4> {
public:
  inline static constexpr UEFI::Guid Id{
      0x65530bc7,
      0xa359,
...
template <> class ProtocolTraits<Udp4ServiceBinding> {
public:
  inline static constexpr UEFI::Guid Id{
      0x83f01464,
      0x99bd,
...
template <> class ProtocolTraits<Udp4> {
public:
  inline static constexpr UEFI::Guid Id{
      0x3ad9df29,
      0x4501,
...
template <> class ProtocolTraits<UEFI::DevicePathProtocol> {
public:
  inline static constexpr UEFI::Guid Id{
      0x09576e91,
      0x6d3f,
