...
class KeyShift {
public:
  inline static constexpr KeyShiftState RightShiftPressed =
      Foundation::Bit::Mask<KeyShiftState>(0);
  inline static constexpr KeyShiftState LeftShiftPressed =
      Foundation::Bit::Mask<KeyShiftState>(1);
  inline static constexpr KeyShiftState RightControlPressed =
      Foundation::Bit::Mask<KeyShiftState>(2);
  inline static constexpr KeyShiftState LeftControlPressed =
      Foundation::Bit::Mask<KeyShiftState>(3);
  inline static constexpr KeyShiftState RightAltPressed =
      Foundation::Bit::Mask<KeyShiftState>(4);
  inline static constexpr KeyShiftState LeftAltPressed =
      Foundation::Bit::Mask<KeyShiftState>(5);
  inline static constexpr KeyShiftState RightLogoPressed =
      Foundation::Bit::Mask<KeyShiftState>(6);
  inline static constexpr KeyShiftState LeftLogoPressed =
      Foundation::Bit::Mask<KeyShiftState>(7);
  inline static constexpr KeyShiftState MenuKeyPressed =
      Foundation::Bit::Mask<KeyShiftState>(8);
  inline static constexpr KeyShiftState SysReqPressed =
      Foundation::Bit::Mask<KeyShiftState>(9);

  inline static constexpr KeyShiftState Valid =
      Foundation::Bit::Mask<KeyShiftState>(31);
};

class KeyToggle {
public:
  inline static constexpr KeyToggleState ScrollLockActive =
      Foundation::Bit::Mask<KeyToggleState>(0);
  inline static constexpr KeyToggleState NumLockActive =
      Foundation::Bit::Mask<KeyToggleState>(1);
  inline static constexpr KeyToggleState CapsLockActive =
      Foundation::Bit::Mask<KeyToggleState>(2);

  inline static constexpr KeyToggleState KeyStateExposed =
      Foundation::Bit::Mask<KeyToggleState>(6);
  inline static constexpr KeyToggleState Valid =
      Foundation::Bit::Mask<KeyToggleState>(7);
};
...
public:
  ...
  [[nodiscard]] constexpr auto ShiftPressed() const -> Foundation::Bool {
    return Foundation::Bit::IsSet(KeyShiftState,
                                  KeyShift::LeftShiftPressed |
                                      KeyShift::RightShiftPressed);
  }

  [[nodiscard]] constexpr auto ControlPressed() const -> Foundation::Bool {
    return Foundation::Bit::IsSet(KeyShiftState,
                                  KeyShift::LeftControlPressed |
                                      KeyShift::RightControlPressed);
  }

  [[nodiscard]] constexpr auto AltPressed() const -> Foundation::Bool {
    return Foundation::Bit::IsSet(KeyShiftState, KeyShift::LeftAltPressed |
                                                     KeyShift::RightAltPressed);
  }
...
using InputResetExFn = UEFI::StatusValue (*)(
    SimpleTextInputEx *This, Foundation::Bool ExtendedVerification);
using ReadKeyStrokeExFn = UEFI::StatusValue (*)(SimpleTextInputEx *This,
                                                KeyData *KeyData);
using SetStateFn = UEFI::StatusValue (*)(SimpleTextInputEx *This,
                                         KeyToggleState *KeyToggleState);
using KeyNotifyFn = UEFI::StatusValue (*)(KeyData *KeyData);
using RegisterKeyNotifyFn = UEFI::StatusValue (*)(
    SimpleTextInputEx *This, KeyData *KeyData,
    KeyNotifyFn KeyNotificationFunction, Foundation::Void **NotifyHandle);
using UnregisterKeyNotifyFn = UEFI::StatusValue (*)(
    SimpleTextInputEx *This, Foundation::Void *NotificationHandle);
...
public:
  ...
  [[nodiscard]] auto RegisterNotify(KeyData &Data, KeyNotifyFn Function,
                                    Foundation::Void *&NotifyHandle)
      -> UEFI::StatusValue;

  [[nodiscard]] auto UnregisterNotify(Foundation::Void *NotifyHandle)
      -> UEFI::StatusValue;

  [[nodiscard]] constexpr auto
  operator<=>(const SimpleTextInputEx &) const = default;
};
...
static_assert(
    Foundation::Traits::IsTriviallyCopyable<SimpleTextInputEx>::Value);
} // namespace UEFIpp::Protocols
