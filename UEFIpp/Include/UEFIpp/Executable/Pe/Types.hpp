...
enum class SectionCharacteristic : Foundation::Uint32 {
  None = 0,
  Code = 0x00000020u,
  InitializedData = 0x00000040u,
  UninitializedData = 0x00000080u,
  Discardable = 0x02000000u,
  NotCached = 0x04000000u,
  NotPaged = 0x08000000u,
  Shared = 0x10000000u,
  Execute = 0x20000000u,
  Read = 0x40000000u,
  Write = 0x80000000u
...
[[nodiscard]] constexpr auto operator|(SectionCharacteristic Left,
                                       SectionCharacteristic Right) noexcept
    -> SectionCharacteristic {
  return Foundation::Cast::Auto<SectionCharacteristic>(
      Foundation::Cast::Underlying(Left) | Foundation::Cast::Underlying(Right));
}

[[nodiscard]] constexpr auto
HasCharacteristic(SectionCharacteristic Value,
                  SectionCharacteristic Flag) noexcept -> Foundation::Bool {
...
[[nodiscard]] auto IsDosHeaderValid(const DosHeader &Header)
    -> Foundation::Bool;

[[nodiscard]] auto IsNtSignatureValid(Foundation::Uint32 Signature)
    -> Foundation::Bool;
} // namespace UEFIpp::Executable::Pe
