...
public:
  ...
  constexpr explicit FileInfo(Memory::AllocatorStub Allocator) noexcept
      : Path_(Allocator) {}

  // Constructs file information from its components
  FileInfo(const FileSystem::Path &Path, Foundation::Uint64 Size,
           Foundation::Uint64 PhysicalSize, const FileSystem::Time &CreatedTime,
  ...
  [[nodiscard]] auto operator==(const FileInfo &) const
