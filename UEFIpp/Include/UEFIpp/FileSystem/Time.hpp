...
public:
  ...
  Time(Foundation::Uint16 Year, Foundation::Uint8 Month, Foundation::Uint8 Day,
       Foundation::Uint8 Hour, Foundation::Uint8 Minute,
       Foundation::Uint8 Second, Foundation::Uint32 Nanosecond = 0);
  ...
  [[nodiscard]] auto operator==(const Time &) const
