    ...
    public:
        ...
        [[nodiscard]] static auto Parse(Library::StringView Text, IPv4Address& Out) -> Foundation::Bool
        {
            ...
            for (Foundation::Size i = 0; i <= Text.Size(); ++i)
            {
                ...
                if (Ch != '.' || !HaveDigit || Part >= 4) return false;
        ...
        [[nodiscard]] constexpr auto A() const -> Foundation::Uint8 { return Bytes_[0]; }
        [[nodiscard]] constexpr auto B() const -> Foundation::Uint8 { return Bytes_[1]; }
        [[nodiscard]] constexpr auto C() const -> Foundation::Uint8 { return Bytes_[2]; }
        [[nodiscard]] constexpr auto D() const -> Foundation::Uint8 { return Bytes_[3]; }
        [[nodiscard]] constexpr auto Bytes() const -> const Foundation::Uint8* { return Bytes_; }
        constexpr auto Clear() -> Foundation::Void { Bytes_[0] = Bytes_[1] = Bytes_[2] = Bytes_[3] = 0; }
