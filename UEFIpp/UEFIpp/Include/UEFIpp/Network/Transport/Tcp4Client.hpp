...
namespace UEFIpp::Network
{
	...
	public:
		...
		[[nodiscard]] auto Send(ByteSpan Data) -> Foundation::Bool;
		[[nodiscard]] auto Send(Library::StringView Text) -> Foundation::Bool;

		[[nodiscard]] auto Receive(Library::Vector<Foundation::Byte>& Buffer, Foundation::Size Capacity = 4096) -> Foundation::Bool;
		[[nodiscard]] auto Receive(Library::String& Text, Foundation::Size Capacity = 4096) -> Foundation::Bool;
