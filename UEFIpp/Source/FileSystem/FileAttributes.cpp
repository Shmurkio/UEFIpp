...
auto FileAttributes::Mask() const -> Foundation::Uint64 { return Mask_; }
...
FileAttributes::FileAttributes(FileAttribute Attribute)
    : Mask_(Foundation::Cast::Auto<Foundation::Uint64>(Attribute)) {}

// Constructs file attributes from a raw mask
FileAttributes::FileAttributes(Foundation::Uint64 Mask) : Mask_(Mask) {}
} // namespace UEFIpp::FileSystem
